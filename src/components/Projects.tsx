...
function CardButtons({ demo, github }: { demo: string; github: string }) {
  return (
    <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
      <a href={demo} target="_blank" rel="noopener noreferrer" title="Ver proyecto"
        style={{
        ...
        onMouseEnter={e => { e.currentTarget.style.background = "#333"; e.currentTarget.style.transform = "scale(1.08)"; }}
      ...
      <a href={github} target="_blank" rel="noopener noreferrer" title="Ver código"
        style={{
          width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center",
          background: "white", color: "#111", borderRadius: 10,
          border: "1px solid #E0E0E0", textDecoration: "none",
          transition: "border-color 0.18s, background 0.18s, transform 0.15s", flexShrink: 0,
        }}
        onMouseEnter={e => { e.currentTarget.style.borderColor = "#BBB"; e.currentTarget.style.background = "#F5F5F5"; e.currentTarget.style.transform = "scale(1.08)"; }}
        onMouseLeave={e => { e.currentTarget.style.borderColor = "#E0E0E0"; e.currentTarget.style.background = "white"; e.currentTarget.style.transform = "scale(1)"; }}
      >
...
/* Card móvil — sin restricciones de altura */
function MobileCard({ p }: { p: typeof projects[0] }) {
  return (
    <div style={{
      ...
      <div style={{ position: "relative", height: 200, overflow: "hidden" }}>
        <Image src={p.image} alt={p.title} fill sizes="100vw" style={{ objectFit: "cover" }} />
        <div style={{
      ...
      <div style={{ padding: "14px 16px 16px" }}>
        ...
        <p style={{ fontSize: 17, fontWeight: 700, color: "#111", marginBottom: 10 }}>
          {p.title}
        </p>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
          ...
          <CardButtons demo={p.demo} github={p.github} />
        </div>
      </div>
    </div>
  );
  ...
  useEffect(() => {
    ...
    cards.forEach((card, i) => {
      gsap.set(card, {
        ...
        x: stackX + i * 7, y: stackY + i * 5,
        rotation: rots[i], zIndex: cards.length - i,
  ...
  return (
    <section id="projects" style={{ marginBottom: 80 }}>
      <style>{`
        ...
        .projects-desktop { display: block; }
      ...
      {/* ── MÓVIL: lista vertical simple, sin GSAP ── */}
      <div className="projects-mobile">
        <p style={{
          fontSize: 12, fontWeight: 700, color: "#AAAAAA",
          letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 20,
        }}>Proyectos</p>
        {projects.map(p => <MobileCard key={p.title} p={p} />)}
      </div>

      {/* ── TABLET / DESKTOP: animación GSAP ── */}
      <div className="projects-desktop">
        <div ref={outerRef} style={{ position: "relative", height: `${projects.length * 120 + 60}vh` }}>
              ...
              >
                ...
                <div className="card-img-wrap" style={{ position: "relative", height: "50%", overflow: "hidden", borderRadius: "18px 18px 0 0" }}>
                  ...
                  <div className="card-overlay" style={{
                    ...
                    <p style={{ color: "rgba(255,255,255,0.92)", fontSize: 14, lineHeight: 1.65, textAlign: "center" }}>
                      {p.description}
                    </p>
                  </div>
                </div>
